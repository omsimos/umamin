...
// Session-scoped, not component state: virtualized/paged rows can unmount, and
// an in-flight refetch can clobber the optimistic patch with the stale sealed
// row — without this, a remount re-seals a message the user already read.
const revealedIds = new Set<string>();

export function ReceivedMessageCard({ data }: { data: MessageWithReceiver }) {
