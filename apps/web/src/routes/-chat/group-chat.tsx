...
// 8s: the head poll is the only continuous interval poller and each tick is a
...
export function GroupChat({
  ...
  // Head-gated delta poll, paused when hidden.
  useQuery({
  ...
  return (
    // Full-screen immersive thread. Safe-area insets on header (top) + composer
    // (bottom) so the overlay clears the notch/home indicator in standalone PWA.
