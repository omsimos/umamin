...
function denyIpAction(input: { ip: string }) {
  return callAction<{ success: boolean }>("denyIpAction", input);
}

function allowIpAction(input: { ip: string }) {
  return callAction<{ success: boolean }>("allowIpAction", input);
}
