...
// Was an RSC that awaited getSession(); under TanStack Start the session is read
// through the shared current-user query (hydrated by the route loader in Phase
// 3b). `session` is simply "is there a logged-in user".
