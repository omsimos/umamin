...
/**
 * Static Hot score shared by the ranked-id list and the SQL fallback so both
 ...
 * ranking cheaply recomputable — no per-request re-score sweeps.
 *
...
// Float — what the ranked list orders by.
