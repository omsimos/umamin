...
import { ScanFaceIcon, BadgeCheckIcon } from "lucide-react";
      ...
      <CardHeader className="w-full pb-4 text-sm">
        <div className="flex justify-between items-start">
          ...
          <div className="flex gap-x-1 text-muted-foreground items-center">
            ...
            {/* {currentUserId && data.user?.quietMode && ( */}
            {/*   <MessageCircleOffIcon className="size-4" /> */}
            {/* )} */}

            {/* {currentUserId && !data.isAnonymous && !data.user?.quietMode && ( */}
            {/*   <button */}
            {/*     data-testid="data-reply-btn" */}
